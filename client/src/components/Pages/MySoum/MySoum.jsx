...
import { convertDateToLocal, getDateInISOFormat, options } from '../../Utils/Utils';

const MySoum = () => {
    const { state: { userInfo, accounts, arrayLot, myParticipation }, waiting } = useEth();
    ...
    useEffect(() => {
        ...
        if (arrayLot.length > 0) {
            for (let i = 0; i < arrayLot.length; i++) {
                for (let a = 0; a < myParticipation.length; a++) {
                    if (arrayLot[i].index === myParticipation[a].idLot) {
                                ...
                                <div id='top-array-soum'>
                                    ...
                                    <div id="top-array-soum-rigth">
                                        <Link to={`/Account/${userInfo.name}/Soum`}>
                                            <button className='myButton'>Voir les lots en cours</button>
                                        </Link>
                                        <span></span>
                                                                ...
                                                                {accounts !== value.adressDDO.toLowerCase() && (
                                                                    <div className="tr-data">
                                                                        <Link 
                                                                            ...
                                                                            state={{value,userInfo,arrayLot,context:'Mysoum'}}
                                                                        >
