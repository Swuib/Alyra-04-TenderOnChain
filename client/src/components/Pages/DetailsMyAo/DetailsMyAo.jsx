...
const DetailsMyAo = () => {
    const { state: {artifact,contract,accounts, userInfo, myArrayLot },init } = useEth();
                                                            ...
                                                            {myArrayLotFilted.map((value, key) => {
                                                                return(
                                                                    <div key={`data-${key}-${value.index}`} className='data-myao'>   
                                                                        ...
                                                                        <div className="tr-data">
                                                                            <Link to={`/Account/${userInfo.name}/${value.index}/DetailLot`} state={{value,userInfo, Ao:locationState.value}}>
